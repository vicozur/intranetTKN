...
<head>
    ...
    <title>TKN Intranet | <?php echo $title; ?></title>
    <!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="TKN Intranet. System | Inicio" />
    <meta name="author" content="I.S.T. Zurita" />
    <meta
        name="description"
        content="Sistema de administracion de informacion de clientes y pproyectos en biblioteca." />
    <meta
        name="keywords"
        content="Clientes, proyectos, telefono, email, codigo" />
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">TKN Intranet</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>

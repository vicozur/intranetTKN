...
<head>
    ...
    <title>tkn System | Login Page</title>
    <!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="author" content="I.S.T.Zurita" />
    <meta
        name="description"
        content="Internal System is an application for recording information on clients anf proyects in TKN s.r.l." />
    <meta name="keywords" content="clients, proyects, informacion" />
    ...
    <div class="login-box">
        <div class="card">
            <div class="login-logo">
                <img src="<?= base_url('assets/img/logo.png') ?>" alt="TKN s.r.l." style="margin-top:10px;  max-width:40%; height:auto;">
                <h4><b>Intranet empresarial</b></h4>
            </div>
            ...
            <div class="card-body login-card-body">
                <p class="login-box-msg">Autentica para iniciar tu sesi&oacute;n</p>
